...
import { io } from "socket.io-client";
>>>>>>> a734071c7620ae4bf84975ca0bf296a634ea7213
  ...
  const handleSlotClickEdit = (s: string, e: string) => {
    ...
    setEditValues((prev) => {
      ...
      if (!next.startTime) {
        ...
        const isSingle =
          TIME_SLOTS.find((t) => t.start === next.startTime)?.end ===
          next.endTime;
  ...
  const calculateEditPrice = async (values: {
    ...
    try {
      ...
      const msg =
        ...
        "Không tính được tiền sân, vui lòng kiểm tra giờ!";
      toast.error(msg);
      ...
      >
        {checkinBooking && (
          <div className="space-y-4">
            ...
            <div className="text-xs text-gray-500">
              💡 Tiền thiết bị sẽ được cộng vào tổng tiền đơn và lưu lại khi
              check-in.
            </div>
          </div>
        )}
