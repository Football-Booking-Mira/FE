...
const Checkout: React.FC = () => {
  ...
  return (
    // <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 flex justify-center items-start py-12 px-4">
    //   <Card className="w-full max-w-2xl shadow-2xl rounded-3xl overflow-hidden">
    //     {/* Header */}
    //     <div className=" text-green text-center py-6 px-4">
