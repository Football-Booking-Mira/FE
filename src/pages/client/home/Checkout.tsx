...
const Checkout: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (bookingData.isRetryPayment && bookingData.bookingId) {
            fetch(`http://localhost:3000/api/bookings/${bookingData.bookingId}/retry-payment-info`)
                .then((r) => r.json())
                .then((res) => {
                    const info = res.data;
                    setRetryInfo({
                ...
                .catch((err) => {
                    ...
                    const msg =
                        ...
                        'Không thể thanh toán lại đơn này!';
                    toast.error(msg);
    ...
    const handleSubmit = async () => {
        ...
        } else if (!vietnamPhoneRegex.test(phoneTrim)) {
            newErrors.phone =
                'Số điện thoại phải bắt đầu bằng 0, là số di động Việt Nam hợp lệ (VD: 03..., 05..., 07..., 08..., 09...)';
        }
