...
export function SigninPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
            ...
            {/* Right Side: Form */}
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 sm:px-12 lg:px-24 relative bg-white dark:bg-gray-950 transition-colors duration-300">
                <Link to="/" className="absolute top-8 left-8 text-gray-500 dark:text-gray-400 hover:text-green-500 font-medium flex items-center gap-2 transition-colors">
