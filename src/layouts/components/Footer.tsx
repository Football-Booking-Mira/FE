  ...
  return (
    <footer className="bg-[#0b132b] text-white mt-16">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-6 py-12 border-t border-gray-700">
        ...
        <div>
          ...
          <p className="text-gray-300">
            Hệ thống sân bóng đá hiện đại với đầy đủ tiện ích. Chúng tôi cam kết
            mang đến trải nghiệm chơi bóng tuyệt vời nhất cho mọi đội bóng.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-300">
            ...
            <li>
              <a href="/my-bookings" className="hover:text-green-500">
                Đặt sân
              </a>
            </li>
            <li>
      ...
      <div className="border-t border-gray-700 text-center py-4 text-gray-400 text-sm">
        © 2024 <span className="text-green-500 font-semibold">Green Field</span>
